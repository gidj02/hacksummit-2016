(function (exports, ctx) {
  $((function () {
    $('<link href="assets/libs/plugins/here/prism.css" rel="stylesheet">').appendTo('head');
    $('<script type="text/javascript" src="assets/libs/plugins/here/prism.js" >').appendTo('head');
